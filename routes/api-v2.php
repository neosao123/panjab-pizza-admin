...
use App\Http\Controllers\Api\V2\CashierController;
use App\Http\Controllers\Api\V2\CustomerController;
use App\Http\Controllers\Api\V2\SpecialOfferController;
use App\Http\Controllers\Api\V2\SignaturePizzaController;
use App\Http\Controllers\Api\V2\CashierOrderController;
use App\Http\Controllers\Api\V2\InvoicesController;
use App\Http\Controllers\Api\V2\CustomerOrderController;
use App\Http\Controllers\Api\V2\PaymentController;
use App\Http\Controllers\Api\V2\StoreReportsController;
use App\Http\Controllers\Api\V2\PizzasController;
use App\Http\Controllers\Api\V2\TestController;
use App\Http\Controllers\Api\V2\BackgroundImageController;
...
Route::get('/mas/vx/ingredients', [TestController::class, 'ingredients']);
...
Route::group(['middleware' => 'cors'], function () {
    ...
    Route::group(['prefix' => 'cashier'], function () {
        ...
        Route::post('/send-otp', [CashierOrderController::class, 'sendOTP']);
        Route::post('/resend-otp', [CashierOrderController::class, 'resendOTP']);
        Route::post('/verify-otp', [CashierOrderController::class, 'verifyOTP']);
    });
