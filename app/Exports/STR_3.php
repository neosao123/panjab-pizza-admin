...
class STR_3 implements FromView, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        return view('exports.STR_3', [
            'storeLocation' => DB::table('storelocation')->where('code', 'STR_3')->first(),
            'orders' => OrderMaster::whereBetween('created_at', [$prev24Hours, $now])->where('storeLocation', 'STR_3')->get()
        ]);
    }
}
