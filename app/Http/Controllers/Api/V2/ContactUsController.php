...
class ContactUsController extends Controller
{
    ...
    public function contact_us(Request $request)
    {
        try {
            ...
            $adminEmail = 'seemashelar01@gmail.com'; // Change to actual franchise email
            ...
            <table width="600" align="center" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="text-align:center; padding-bottom:20px;">
                        <h2 style="margin:0; color:#333;">New Franchise Application</h2>
                    </td>
                </tr>

                <tr>
                    <td>
                        <h3 style="color:#444; border-bottom:1px solid #eee; padding-bottom:5px;">Personal Information</h3>
                ...
                <tr>
                    <td>
                        <h3 style="color:#444; border-bottom:1px solid #eee; padding-bottom:5px;">Location Details</h3>
                ...
                <tr>
                    <td>
                        <h3 style="color:#444; border-bottom:1px solid #eee; padding-bottom:5px;">Financial Information</h3>
                ...
                <tr>
                    <td>
                        <h3 style="color:#444; border-bottom:1px solid #eee; padding-bottom:5px;">Other Preferences</h3>
                        <p><strong>Preferred Language:</strong> ' . $applicationData['preferred_language'] . '</p>
                    </td>
                </tr>

                <tr>
                    <td style="padding-top:20px; color:#777;">
                        <p><strong>Application Submitted On:</strong> ' . now()->format("Y-m-d H:i:s") . '</p>
                    </td>
                </tr>
