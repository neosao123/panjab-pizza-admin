    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                @if ($queryresult)
                    <form action="{{ url('/dips/update') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                ...
                                <input type="text" id="dips" name="dips" class="form-control" required
                                    value="{{ $queryresult->dips }}" data-parsley-required-message="Dips is required"
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="number" id="price" name="price" step="0.01" min="1"
                                    class="form-control" value="{{ $queryresult->price }}" required
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="file" id="file" class="form-control " name="dipsImage"
                                    accept=".jpg, .jpeg, .png">
                            ...
                            @if (!empty($queryresult->dipsImage))
                                <div class="col-md-3 mb-3" id="eImage">
                                    <img class="img-thumbnail mb-2" width="100" height="100" id="showProfileImg"
                                        src="{{ url('uploads/dips/' . $queryresult->dipsImage) . '?v=' . time() }}"
                                        data-src="">
                                    <a class="btn btn-danger text-white"
                                        onclick="deleteImage('{{ $queryresult->code }}','{{ $queryresult->dipsImage }}');"><i
