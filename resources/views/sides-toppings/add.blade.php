@extends('template.master', ['pageTitle' => 'Sides-Toppings Add'])
@push('styles')
...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Sides-Toppings Add</h4>
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="addressform" action="{{ url('/sides-toppings/store') }}" method="post" enctype="multipart/form-data" data-parsley-validate="">
                @csrf
                <div class="row">
                    <div class="col-sm-12 form-group">
                        <label>Toppings Name : <span style="color:red">*</span></label>
                        <input type="text" id="toppingsName" name="toppingsName" class="form-control" value="{{ old('toppingsName') }}">
