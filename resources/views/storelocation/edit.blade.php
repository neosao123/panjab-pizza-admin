          ...
          <div class="row">
            ...
            <div class="col-md-6 form-group">
              ...
              <input list="cities" id="city" name="city" autocomplete="off" class="form-control mb-2" required
                value="{{ old('city') ? old('city') : $queryresult->city }}"
              ...
              <div class="row gx-3 mb-2">
                ...
                <div class="col-9">
                  <input class="form-control"
                    ...
                    name="wd_start_time" type="text" placeholder="Select Start Time.." id="wd_start_time" required
              ...
              <div class="row gx-3 mb-2">
                ...
                <div class="col-9">
                  <input class="form-control"
                    ...
                    name="wd_end_time" type="text" placeholder="Select End Time.." id="wd_end_time" required
              ...
              <div class="row gx-3 mb-2">
                ...
                <div class="col-9">
                  <input class="form-control"
                    ...
                    name="we_start_time" type="text" placeholder="Select Start Time.." id="we_start_time" required
                    data-parsley-required-message="The start time is required">
                </div>
              </div>
              <div class="row gx-3 mb-2">
                ...
                <div class="col-9">
                  <input class="form-control"
                    ...
                    name="we_end_time" type="text" placeholder="Select End Time.." id="we_end_time" required
                    data-parsley-required-message="The end time is required">
                </div>
              </div>
            </div>
