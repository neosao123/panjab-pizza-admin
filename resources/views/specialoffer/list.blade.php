@extends('template.master', ['pageTitle' => 'Special Offer List'])
@push('styles')
    ...
    <div class="row">
        ...
        <?php if ($insertRights == 1) { ?>
            <div class="col-7 align-self-center">
                <a href="{{ url('specialoffer/add') }}" class="btn btn-info btn-sm float-right">Add New</a>
            </div>
        <?php } ?>
    </div>
</div>
<div class="container-fluid">
            ...
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-sm-3 form-group">
                            ...
                            <div class="form-group">
                                <select class="select2 form-control custom-select" style="width: 100%;" name="specialoffer" id="specialoffer">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <h5 class="mb-0" data-anchor="data-anchor">Special Offer list</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dataTable-Specialoffer" style="width:100%" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
                                        <th>Sr. No. </th>
                                        <th>Action</th>
    ...
    <script type="text/javascript" src="{{ asset('theme/init_site/specialoffer/index.js?v=' . time()) }}"></script>
    @if (session('success'))
    <script>
