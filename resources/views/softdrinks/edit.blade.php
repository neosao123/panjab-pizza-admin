...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            @if($queryresult)
            <form id="addressform" action="{{ url('/softdrinks/update') }}" method="post" enctype="multipart/form-data" data-parsley-validate="">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="text" id="softdrinks" name="softdrinks" class="form-control" required value="{{ $queryresult->softdrinks }}" data-parsley-required-message="Soft Drink name is required" maxlength='150' data-parsley-minlength="3" data-parsley-minlength-message="You need to enter at least 3 characters" data-parsley-trigger="change">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="number" id="price" name="price" step="0.01" min="1" max="9999999" class="form-control" value="{{ $queryresult->price }}" required data-parsley-required-message="Price is required" data-parsley-trigger="change" data-parsley-gt="#nonzero">
                        <span class="text-danger">
                            @error('price')
                            {{ $message }}
                            @enderror
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="number" id="drinksCount" name="drinksCount" step="0.01" min="1" max="9999999" class="form-control" value="{{ $queryresult->drinksCount }}" required data-parsley-required-message="Drinks Count is required" data-parsley-trigger="change" data-parsley-gt="#nonzero">
                        <span class="text-danger">
                            @error('drinksCount')
                            {{ $message }}
                            @enderror
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control" id="type" name="type" required data-parsley-required-message="Type is required.">
                    ...
                    <div class="col-md-3">
                        <label class="form-label" for="form-wizard-progress-wizard-softdrinkimage">Soft Drink Image</label>
                        <input type="file" id="file" class="form-control " name="softDrinkImage" accept=".jpg, .jpeg, .png">
                    ...
                    <div class="col-md-3 mb-3" id="eImage">
                        ...
                        <a class="btn btn-danger text-white" onclick="deleteImage('{{ $queryresult->code }}','{{ $queryresult->softDrinkImage }}');"><i class="fa fa-trash"></i></a>
                    </div>
                    @endif
