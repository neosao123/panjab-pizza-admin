...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="softdrinkForm" action="{{ url('/softdrinks/store') }}" method="post" enctype="multipart/form-data" data-parsley-validate>
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="text" id="softdrink" name="softdrink" class="form-control" required
                            value="{{ old('softdrink') }}"
                            data-parsley-required-message="Soft Drink name is required"
                            maxlength='150'
                            data-parsley-minlength="3"
                            data-parsley-minlength-message="You need to enter at least 3 characters"
                            data-parsley-trigger="change">
                        <span class="text-danger">@error('softdrink') {{ $message }} @enderror</span>
                    </div>

                    <!-- Price -->
                    <div class="col-sm-6 form-group">
                        <label>Price : <span style="color:red">*</span></label>
                        <input type="number" id="price" name="price" step="0.01" min="0.01" max="9999999" class="form-control"
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="number" id="drinksCount" name="drinksCount" step="0.01" min="1" max="9999999" class="form-control"
                            value="{{ old('drinksCount') }}" required
                            data-parsley-required-message="Drinks Count is required"
                            data-parsley-trigger="change" data-parsley-gt="#nonzero">
                        <span class="text-danger">@error('drinksCount') {{ $message }} @enderror</span>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <span class="text-danger">@error('drinksType') {{ $message }} @enderror</span>
                    </div>
