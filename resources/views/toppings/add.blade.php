    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Toppings Add</h4>
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="addressform" action="{{ url('/toppings/store') }}" method="post" enctype="multipart/form-data"
                    data-parsley-validate="">
                    @csrf
                    <input type="hidden" readonly id="countAs" name="countAs" value="1">
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" id="regular" name="topping_type" class="custom-control-input"
                                    value="regular" data-count-as="1" checked>
                                <label class="custom-control-label" for="regular">{{ $settingRegular->settingValue }} (1)</label>
                            </div>
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="non-regular">{{ $settingNonRegular->settingValue }}
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="number" id="price" name="price" step="0.01" min="0"
                                class="form-control" max="9999999" value="" required
