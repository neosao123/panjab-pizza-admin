@extends('template.master', ['pageTitle'=>"Category List"])
@push('styles')
...
<div class="page-breadcrumb">
    <div class="row">
        ...
        <!-- Seema Shelar - Add Signature Pizza Category -->
        <div class="col-7 align-self-center">
            <a href="{{ url('signature-pizza-category/add') }}" class="btn btn-info btn-sm float-right">Add New</a>
        </div>
    </div>
</div>
<div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <h5 class="mb-0" data-anchor="data-anchor">Category list</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dataTable-Signature-Pizza-Category" style="width:100%" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
    ...
    <script type="text/javascript" src="{{ asset('theme/init_site/signature-pizza-category/index.js?v=' . time()) }}"></script>
