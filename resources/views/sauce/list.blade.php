@extends('template.master', ['pageTitle'=>"Sauce List"])
@push('styles')
...
<div class="page-breadcrumb">
    <div class="row">
        ...
        <div class="col-7 align-self-center">
            <a href="{{ url('sauce/add') }}" class="btn btn-info btn-sm float-right">Add New</a>
        </div>
    </div>
</div>
<div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <h5 class="mb-0" data-anchor="data-anchor">Sauce list</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dataTable-Sauce" style="width:100%" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
                                        <th style="width:5%;">Sr. No. </th>
                                        <th style="width:5%;">Action</th>
                                        <th style="width:70%;">Sauce</th>
    ...
    <script type="text/javascript" src="{{ asset('theme/init_site/sauce/index.js?v=' . time()) }}"></script>
