@extends('template.master', ['pageTitle' => 'Sauce View'])
@section('content')
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Sauce View</h4>
            ...
            <form>
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label>Name : </label>
                        <input type="text" id="sauce" name="sauce" class="form-control-line" value="{{ $queryresult->sauce }}" readonly>
