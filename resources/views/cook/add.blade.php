@extends('template.master', ['pageTitle' => 'Cook Add'])
...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Cook Add</h4>
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="cookForm" action="{{ url('/cook/store') }}" method="post" enctype="multipart/form-data" data-parsley-validate>
                @csrf
