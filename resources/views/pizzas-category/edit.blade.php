@extends('template.master', ['pageTitle' => 'Category Edit'])
@push('styles')
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
			@if($queryresult)
            <form id="addressform" action="{{ url('/pizzas-category/update') }}" method="post" enctype="multipart/form-data" data-parsley-validate="">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="text" id="categoryName" name="categoryName" class="form-control" required value="{{ $queryresult->category_name }}" data-parsley-required-message="Category name is required" maxlength='150' data-parsley-minlength="3" data-parsley-minlength-message="You need to enter at least 3 characters" data-parsley-trigger="change" onkeypress="return ValidateAlpha(event)">
...
<script type="text/javascript" src="{{ asset('theme/init_site/pizzas-category/edit.js?v=' . time()) }}"></script>
