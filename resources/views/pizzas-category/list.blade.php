...
<div class="page-breadcrumb">
    <div class="row">
        ...
        <!-- Seema Shelar - Add Pizzas Category -->
        <div class="col-7 align-self-center">
            <a href="{{ url('pizzas-category/add') }}" class="btn btn-info btn-sm float-right">Add New</a>
        </div>
    </div>
</div>
<div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dataTable-Pizzas-Category" style="width:100%" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
    ...
    <script type="text/javascript" src="{{ asset('theme/init_site/pizzas-category/index.js?v=' . time()) }}"></script>
