...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            @if($queryresult)
            <form id="addressform" action="{{ url('/sides/update') }}" method="post" enctype="multipart/form-data" data-parsley-validate="">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="text" id="sideName" name="sideName" class="form-control" required value="{{ $queryresult->sidename }}" data-parsley-required-message="Side name is required" maxlength='150' data-parsley-minlength="3" data-parsley-minlength-message="You need to enter at least 3 characters" data-parsley-trigger="change" onkeypress="return ValidateAlpha(event)">
                    ...
                    <div class="col-md-3 mb-3 form-group " id="eImage">
                        <img class="img-thumbnail mb-2" width="100" height="100" id="showSideImg" src="{{ url('uploads/sides/' . $queryresult->image). '?v=' . time() }}" data-src="">
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <input type="hidden" class="form-control" name="rowCode[]" value="{{$item->code}}">
                        <input type="text" class="form-control" name="size[]" maxlength='80' data-parsley-minlength="2" data-parsley-minlength-message="You need to enter at least 2 characters" data-parsley-trigger="change" value="{{$item->size}}" required data-parsley-required-message="Size is required.">
                    </div>
                    <div class="col-md-4 form-group">
                        <label>Price : <span style="color:red">*</span></label>
                        <input type="number" step="0.01" min="1" class="form-control" name="price[]" required data-parsley-trigger="change" data-parsley-gt="#nonzero" value="{{$item->price}}" data-parsley-required-message="Price is required.">
                    </div>
                </div>
                @endforeach
                @endif
                ...
                <div class="row">
                    <div class="col-md-12 form-group ">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="hasToppings" name="hasToppings" value="1" {{ $queryresult->hasToppings == 1 ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <input type="number" step="1" id="nooftoppings" name="nooftoppings" class="form-control" min="0" value="{{ $queryresult->nooftoppings }}">
                        <span class="text-danger">
                            @error('nooftoppings')
                            {{ $message }}
                            @enderror
