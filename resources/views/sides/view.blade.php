                ...
                <form>
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" id="sideName" name="sideName" class="form-control-line" readonly
                            ...
                            <div class="col-md-3 mb-3 form-group " id="eImage">
                                ...
                                <div class="form-group">
                                    <img class="img-thumbnail mb-2" width="100" height="100" id="showSideImg"
                                        src="{{ url('uploads/sides/' . $queryresult->image) }}" data-src="">
                        ...
                        @foreach ($sidelineentries as $item)
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label>Size</label>
                                    <input type="hidden" class="form-control-line" name="rowCode[]"
                                        value="{{ $item->code }}">
                                    <input type="text" class="form-control-line" name="size[]" readonly
                                        value="{{ $item->size }}">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Price</label>
                                    <input type="text" class="form-control-line" name="price[]"
                                        value="{{ $item->price }}">
                                </div>
                            </div>
                        @endforeach
                        ...
                        <div class="col-md-12 form-group ">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" onclick="return false" class="custom-control-input"
                                    id="hasToppings" name="hasToppings" value="1"
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" step="1" id="nooftoppings" name="nooftoppings"
                                class="form-control-line" value="{{ $queryresult->nooftoppings }}" readonly>
