    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form id="addressform" action="{{ url('/sides/store') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" id="sideName" name="sideName" class="form-control" required
                                value="{{ old('sideName') }}" data-parsley-required-message="Side name is required"
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" id="type" class="form-control" required>
                                ...
                                <option value="plantbites" {{ old('type') == 'plantbites' ? 'selected' : '' }}>Plant Bites
                                </option>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12 form-group ">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="hasToppings" name="hasToppings"
                                    value="1" {{ old('hasToppings') ? 'checked' : '' }}>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" step="1" id="nooftoppings" name="nooftoppings"
                                class="form-control" min="0" value="{{ old('nooftoppings') }}">
                            <span class="text-danger">
                                @error('nooftoppings')
                                    {{ $message }}
                                @enderror
