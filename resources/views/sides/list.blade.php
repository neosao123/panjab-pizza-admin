@extends('template.master', ['pageTitle'=>"Sides List"])
@push('styles')
...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Sides</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Sides</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="col-7 align-self-center">
            <a href="{{ url('sides/add') }}" class="btn btn-info btn-sm float-right">Add New</a>
        </div>
    </div>
</div>
<div class="container-fluid">
            ...
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-sm-3 form-group">
                            ...
                            <div class="form-group">
                                <select class="select2 form-control custom-select" style="width: 100%;" name="sides" id="sides">
                                </select>
                            </div>
                        </div>
						  <div class="col-sm-3 form-group">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <h5 class="mb-0" data-anchor="data-anchor">Sides list</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dataTable-Sides" style="width:100%" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
                                        <th style="width:5%">Sr. No. </th>
										<th style="width:5%">Action</th>
                                        <th style="width:60%">Sides Name</th>
    ...
    <script type="text/javascript" src="{{ asset('theme/init_site/sides/index.js?v=' . time()) }}"></script>
    @if (session('success'))
        <script>
