@extends('template.master', ['pageTitle'=>"Pizza List"])
@push('styles')
...
<div class="page-breadcrumb">
    <div class="row">
        ...
        <div class="col-7 align-self-center">
            <a href="{{ url('signature-pizza/add') }}" class="btn btn-info btn-sm float-right">Add New</a>
        </div>
    </div>
</div>
<div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dataTable-Signature-Pizza" style="width:100%" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
    ...
    <script type="text/javascript" src="{{ asset('theme/init_site/signature-pizza/index.js?v=' . time()) }}"></script>
