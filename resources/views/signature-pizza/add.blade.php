@extends('template.master', ['pageTitle' => 'Signature Pizza add'])
@push('styles')
  ...
  <div class="container-fluid">
    <div class="card">
      ...
      <div class="card-body">
        ...
        @endif
        <form id="inFrom" action="{{ url('/signature-pizza/store') }}" method="post" enctype="multipart/form-data" data-parsley-validate="">
          @csrf
          <div class="row">
            <div class="col-md-6 form-group">
              <label>Name : <span style="color:red">*</span></label>
              <input type="text" id="name" name="name" class="form-control" required value="{{ old('name') }}" data-parsley-required-message="Name is required" maxlength='150'
            ...
            <div class="col-md-3 form-group">
              ...
              <input type="text" id="subtitle" name="subtitle" class="form-control" value="{{ old('subtitle') }}" maxlength='150' data-parsley-minlength="3"
            ...
            @foreach ($pizzaPrices as $item)
              <div class="col-sm-6 col-md-4 col-lg-3 form-group">
                ...
                <input type="hidden" id="size_{{ $item->size }}" name="pizzaPrice[{{ $cnt }}][size]" value="{{ $item->size }}" readonly>
                <input type="hidden" id="size_{{ $item->shortcode }}" name="pizzaPrice[{{ $cnt }}][shortcode]" value="{{ $item->shortcode }}" readonly>
                <input type="number" id="{{ $item->size }}" name="pizzaPrice[{{ $cnt }}][price]" step="0.01" min="0" max="9999" class="form-control"
                  value="{{ $item->price }}" required data-parsley-required-message="Price is required">

                <!-- Radio button to determine the default pizza size -->
                <div class="custom-control custom-radio mt-2 d-none">
                  <input class="custom-control-input" type="radio" id="isDefault_{{ $item->shortcode }}" name="pizzaPrice[{{ $cnt }}][isDefault]" value="1"
            ...
            <div class="col-md-3" id="eImage">
              <img class="img-thumbnail mb-2" width="100" height="100" id="showImage" src="{{ asset('images/default-user.png') }}" data-src="">
            </div>
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('theme/init_site/signature-pizza/add.js?v=' . time()) }}"></script>
