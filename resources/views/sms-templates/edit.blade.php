@extends('template.master', ['pageTitle' => 'SMS Template - Edit'])
@push('styles')
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-sm-12">
            <h5 class="mb-0" data-anchor="data-anchor">Edit SMS Template</h5>
          </div>
        </div>
      </div>
      <div class="card-body">
        ...
        @endif
        <form id="inFrom" action="{{ url('/sms-templates/update') }}" method="post" data-parsley-validate="">
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-12 form-group">
              ...
              <textarea id="template" name="template" class="form-control" rows="6" required
                ...
                data-parsley-trigger="change">{{ old('template') ? old('template') : $queryresult->template }}</textarea>
            ...
            <div class="col-md-12 form-group">
              ...
              <select name="isActive" class="form-control" required>
                <option value="1" {{ old('isActive', $queryresult->isActive) == 1 ? 'selected' : '' }}>Active</option>
                <option value="0" {{ old('isActive', $queryresult->isActive) == 0 ? 'selected' : '' }}>Inactive</option>
              </select>
            </div>
          </div>
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('theme/init_site/sms-templates/edit.js?v=' . time()) }}"></script>
  @if (session('error'))
    <script>
