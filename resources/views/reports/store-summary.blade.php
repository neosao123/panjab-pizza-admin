@extends('template.master', ['pageTitle' => 'Store Summary'])
@push('styles')
...
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Stores Summary</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Stores Summary</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="form-group">
                                    <select class="form-control" id="storeLocation" style="width: 100%;">
                                        ...
                                        @foreach ($storelocation as $storelocations)
                                            <option value="{{ $storelocations->code }}">{{ $storelocations->storeLocation }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable-Reports" style="width:100%"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:10%">Online Orders</th>
                                            <th style="width:10%">In-Store Order</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
    ...
    @push('scripts')
        ...
        <script type="text/javascript" src="{{ asset('theme/init_site/reports/store-summary.js?v=' . time()) }}"></script>
