@extends('template.master', ['pageTitle'=>"Reports List"])
@push('styles')
...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-2 form-group d-none">
                            ...
                            <select class="select2 form-control" style="width: 100%;" id="orderno">
                            </select>
                        </div>
    ...
    <table id="reports" style="width:100%" class="table table-striped table-bordered nowrap d-none">
        <thead>
            <tr>
                <th style="width:5%">Sr. No. </th>
                <th style="width:15%">Store Location</th>
    ...
    <script type="text/javascript" src="{{ asset('theme/init_site/reports/index.js?v=' . time()) }}"></script>
