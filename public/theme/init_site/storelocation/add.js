...
const successCallback = (geolocation) => {
  console.log("latitude IS ", geolocation.coords.latitude);
  console.log("longitude IS ", geolocation.coords.longitude);
  myLatlng = {
...
$(document).ready(function () {
  ...
  function updateTimezone() {
    ...
    // Run the function when the page loads to set the timezone
    updateTimezone();
